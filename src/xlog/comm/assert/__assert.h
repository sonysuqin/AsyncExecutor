...
#define ASSERT2(e, fmt, ...) \
  ((e) ? (void)0             \
       : __ASSERT2(__FILE__, __LINE__, __func__, #e, fmt, ##__VA_ARGS__))
#define ASSERTV2(e, fmt, valist) \
  ((e) ? (void)0 : __ASSERTV2(__FILE__, __LINE__, __func__, #e, fmt, valist))
...
__attribute__((__nonnull__(1, 3, 4))) void __ASSERT(const char*,
                                                    int,
                                                    const char*,
                                                    const char*);
__attribute__((__nonnull__(1, 3, 4, 5)))
__attribute__((__format__(printf, 5, 6))) void
__ASSERT2(const char*, int, const char*, const char*, const char*, ...);
__attribute__((__nonnull__(1, 3, 4, 5)))
__attribute__((__format__(printf, 5, 0))) void
__ASSERTV2(const char*, int, const char*, const char*, const char*, va_list);
__END_DECLS
