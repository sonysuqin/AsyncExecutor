...
template <typename T>
char* string_cast_itoa(const T& value,
                       char* result,
                       uint8_t base = 10,
...
template <>
class number_cast<unsigned long>
    : public detail::__unsigned_number_cast<unsigned long> {
 public:
  number_cast(const char* _str) : __unsigned_number_cast(_str){};
};
template <>
class number_cast<unsigned long long>
    : public detail::__unsigned_number_cast<unsigned long long> {
 public:
  number_cast(const char* _str) : __unsigned_number_cast(_str){};
};
...
class number_cast<bool> {
 public:
  number_cast(const char* _str) : value_(false), vaild_(false) {
    ...
    strutil::SplitToken(_str, strutil::default_delimiters<std::string>::value(),
                        vec_split);
