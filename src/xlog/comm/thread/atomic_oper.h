...
inline uint32_t atomic_cas32(volatile uint32_t* mem,
                             uint32_t with,
                             uint32_t cmp);
...
inline uint32_t atomic_cas32(volatile uint32_t* mem,
                             uint32_t with,
                             uint32_t cmp) {
  return ::_InterlockedCompareExchange(reinterpret_cast<volatile long*>(mem),
                                       with, cmp);
}
...
//! Returns the old value pointed to by mem
inline uint32_t atomic_add32(volatile uint32_t* mem, uint32_t val) {
  return atomic_add_32_nv(reinterpret_cast<volatile ::uint32_t*>(mem),
                          (int32_t)val) -
         val;
}
...
inline uint32_t atomic_cas32(volatile uint32_t* mem,
  ...
  return asm(
      ...
      "    stl_c %t0,(%a0) ;"    // store new value to locked mem (overwriting
                                 // scratch)
...
inline bool stwcxu(volatile uint32_t* mem, uint32_t val) {
  return (__stwcx(reinterpret_cast<volatile int*>(mem),
...
inline bool atomic_add_unless32(volatile uint32_t* mem,
                                uint32_t value,
                                uint32_t unless_this) {
