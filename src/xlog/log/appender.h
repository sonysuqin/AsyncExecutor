...
/*
 * By default, all logs will write to one file everyday. You can split logs to
 * multi-file by changing max_file_size.
 *
 * @param _max_byte_size    Max byte size of single log file, default is 0,
 * meaning do not split.
 */
 ...
 *
 * @param _max_time    Max alive duration of a single log file in seconds,
 * default is 10 days
 */
