...
#include "xlog/comm/compiler_util.h"
...
void __xlogger_VPrint_impl(const XLoggerInfo* _info,
                           const char* _format,
                           va_list _list);
...
void __xlogger_AssertP_impl(const XLoggerInfo* _info,
                            ...
                            const char* _format,
                            va_list _list);
void __xlogger_Assert_impl(const XLoggerInfo* _info,
                           const char* _expression,
                           const char* _log);
...
void xlogger_VPrint(const XLoggerInfo* _info,
                    const char* _format,
                    va_list _list) {
...
void xlogger_AssertP(const XLoggerInfo* _info,
                     const char* _expression,
                     const char* _format,
                     ...) {
...
void xlogger_Assert(const XLoggerInfo* _info,
                    const char* _expression,
                    const char* _log) {
...
void __xlogger_AssertP_impl(const XLoggerInfo* _info,
                            ...
                            const char* _format,
                            va_list _list) {
  __ASSERTV2(_info->filename, _info->line, _info->func_name, _expression,
             _format, _list);
}
